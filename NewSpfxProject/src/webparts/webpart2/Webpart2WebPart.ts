...
import Webpart2 from './components/Webpart2';
import { IWebpart2Props } from './components/IWebpart2Props';
...
export default class Webpart2WebPart extends BaseClientSideWebPart<IWebpart2WebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IWebpart2Props> = React.createElement(
      Webpart2,
      {
